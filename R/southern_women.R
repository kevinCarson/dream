...
#' Dataset is taken from the networkdata R package (Almquist)
#' @usage data(southern.women)
#' @source  Almquist ZW (2014). _networkdata: Lin Freeman's Network Data Collection_. R package version 0.01, <https://github.com/Z-co/networkdata>.
